...
import FormAddFurniture from "@components/Form/FormAddFurniture"
...
const AdminPanel = () => {
  ...
  useEffect(() => {
    !sessionRightUser || sessionRightUser !== "ROLE_ADMIN"
      ? Router.push("/")
      : null
  }, [])
  ...
  return (
    <div
      id="panelAdmin"
      className="container w-full flex flex-wrap mx-auto px-2 pt-8 lg:pt-16 mt-16"
    >
